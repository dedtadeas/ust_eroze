import{$l as e,Jg as t,_t as n,jt as r}from"./index-BqmCqmfp.js";import{h as i}from"./Emissions.glsl-DaTtsIIp.js";import{n as a,t as o}from"./glsl-C2sn87h0.js";import{t as s}from"./Uniform-DXwqrKA1.js";import{t as c}from"./Float4BindUniform-CtMVDjau.js";import{t as l}from"./Float3BindUniform-BrSuqm5i.js";import{t as u}from"./FloatBindUniform-TDSkRzMc.js";import{r as d}from"./AlphaCutoff-DTq90Si4.js";import{t as f}from"./PiUtils.glsl-CZJ_KlHj.js";import{s as p}from"./Transform.glsl-YgD9m_jl.js";var m=3e5,h=5e5;function g(t,n){let i=t.fragment,o=n.lightingSphericalHarmonicsOrder===void 0?2:n.lightingSphericalHarmonicsOrder;o===0?(i.uniforms.add(new l(`lightingAmbientSH0`,({lighting:t})=>e(_,t.sh.r[0],t.sh.g[0],t.sh.b[0]))),i.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):o===1?(i.uniforms.add(new c(`lightingAmbientSH_R`,({lighting:e})=>r(v,e.sh.r[0],e.sh.r[1],e.sh.r[2],e.sh.r[3])),new c(`lightingAmbientSH_G`,({lighting:e})=>r(v,e.sh.g[0],e.sh.g[1],e.sh.g[2],e.sh.g[3])),new c(`lightingAmbientSH_B`,({lighting:e})=>r(v,e.sh.b[0],e.sh.b[1],e.sh.b[2],e.sh.b[3]))),i.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):o===2&&(i.uniforms.add(new l(`lightingAmbientSH0`,({lighting:t})=>e(_,t.sh.r[0],t.sh.g[0],t.sh.b[0])),new c(`lightingAmbientSH_R1`,({lighting:e})=>r(v,e.sh.r[1],e.sh.r[2],e.sh.r[3],e.sh.r[4])),new c(`lightingAmbientSH_G1`,({lighting:e})=>r(v,e.sh.g[1],e.sh.g[2],e.sh.g[3],e.sh.g[4])),new c(`lightingAmbientSH_B1`,({lighting:e})=>r(v,e.sh.b[1],e.sh.b[2],e.sh.b[3],e.sh.b[4])),new c(`lightingAmbientSH_R2`,({lighting:e})=>r(v,e.sh.r[5],e.sh.r[6],e.sh.r[7],e.sh.r[8])),new c(`lightingAmbientSH_G2`,({lighting:e})=>r(v,e.sh.g[5],e.sh.g[6],e.sh.g[7],e.sh.g[8])),new c(`lightingAmbientSH_B2`,({lighting:e})=>r(v,e.sh.b[5],e.sh.b[6],e.sh.b[7],e.sh.b[8]))),i.code.add(a`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`),n.pbrMode!==1&&n.pbrMode!==2||i.code.add(a`const vec3 skyTransmittance = vec3(0.9, 0.9, 1.0);
vec3 calculateAmbientRadiance(float ambientOcclusion)
{
vec3 ambientLight = 1.2 * (0.282095 * lightingAmbientSH0) - 0.2;
return ambientLight *= (1.0 - ambientOcclusion) * skyTransmittance;
}`))}var _=t(),v=n();function y(e){e.uniforms.add(new l(`mainLightDirection`,e=>e.lighting.mainLight.direction))}function b(e){e.uniforms.add(new l(`mainLightIntensity`,e=>e.lighting.mainLight.intensity))}function x(e){y(e.fragment),b(e.fragment),e.fragment.code.add(a`vec3 applyShading(vec3 shadingNormal, float shadow) {
...
}`)}export{C as a,y as c,h as d,w as i,g as l,P as n,b as o,T as r,x as s,F as t,m as u};